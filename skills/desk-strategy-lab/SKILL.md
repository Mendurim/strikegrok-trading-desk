...
- universe: ETH, BTC, SOL perps on Strike
...
1. Instrument and venue. A Strike perp does not inherit an equity-index or spot claim.
...
- **Costs.** Taker and maker fees at the account's tier (the recorded taker rate or the published schedule), funding paid or received each hour the position is open, and slippage per side (default a few bps, or from the Market Analyst's depth read for the intended size).
